...
public class Terrain extends Node implements ITerrain {
	...
	private void makeVegetation(PhysicsSpace pSpace) {
		...
		// positions
		float[][] matrix = { {30, 210}, {-566, 290}, {-762, 394}, {668, 1172}, {1147, 2378},
							 {-834, 3220}, {-2629, 2299}, {-2629, 2100}, {-1924, 283}, {-2290, -1721}, 
							 {19, -2887}, {2036, -271}, {2000, -271}
		                   };
	...
	public float getTerrainBaseHeight() {
		return 260.46f; // TODO: remove this hardcode.
	}
	...
	public Vector3f[] getTanksInitialLocation() {
		return new Vector3f[] {
			// Team 1
			new Vector3f(-1785.54f, 267, 4450.41f),
			new Vector3f(-1695.53f, 267, 4455.00f),
			new Vector3f(-1617.87f, 267, 4459.58f),
			new Vector3f(-1526.56f, 267, 4465.10f),
			new Vector3f(-1442.48f, 267, 4469.98f),
			new Vector3f(-1329.40f, 267, 4476.10f),
			
			// Team 2
			new Vector3f(-1785.54f, 266, -4871.92f),
			new Vector3f(-1695.53f, 266, -4855.48f),
			new Vector3f(-1617.87f, 266, -4845.59f),
			new Vector3f(-1526.56f, 266, -4836.89f),
			new Vector3f(-1442.48f, 266, -4833.40f),
			new Vector3f(-1329.40f, 266, -4826.54f),
		};
	}
