...
/**
 * Wheels of the Panther tank
 * @author Germano Fronza
 */
public class PantherWheel extends Wheel {

	private static final long serialVersionUID = 1L;
	private static final float WHEEL_MASS = 3f;
	private static final float WHEEL_SCALE = 0.8f;
	private static final float TRACTION_SPEED = 40;
	public static final float TURN_SPEED = 45;
	private static final float TRACTION_ACCELERATION = 230;
	private static final float TURN_ACCELERATION = 200;
	private static final float MAX_TURN = 0.3f;
	
	public PantherWheel(DynamicPhysicsNode suspensionBase, Vector3f relativePosition, boolean canTurn) {
