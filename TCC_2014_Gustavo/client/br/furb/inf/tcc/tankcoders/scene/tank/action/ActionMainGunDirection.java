 ...
 * Germano Fronza
 */
public class ActionMainGunDirection implements InputActionInterface {

	ITank tank;
	String tankName;
	int direction;
	
	public ActionMainGunDirection(ITank tank, int direction) {
		this.tank = tank;
	...
	public void performAction(final InputActionEvent e) {
		if (e.getTriggerPressed()) {
            tank.turnMainGun(direction);
        }
        else {
            tank.stopTurningMainGun();
        }
	}
