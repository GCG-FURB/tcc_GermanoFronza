 ...
 */
public class PantherSuspension extends Suspension {
	...
	public PantherSuspension(PhysicsSpace space, DynamicPhysicsNode chassi, Vector3f position, boolean canTurn) {
	...
	protected Wheel makeWheel(DynamicPhysicsNode suspensionBase, Vector3f relativePosition, boolean canTurn) {
		return new PantherWheel(suspensionBase, relativePosition, canTurn);
	}		
}
